...
class SJFEmpty extends Component {
  ...
  turnAroundTimeAverage(tat) {
    ...
    return [
      finalValue,
      tat.length,
      Math.round((finalValue / tat.length + Number.EPSILON) * 100) / 100,
    ];
  }
  ...
  waitingTimeAverage(wt) {
    ...
    return [
      finalValue,
      wt.length,
      Math.round((finalValue / wt.length + Number.EPSILON) * 100) / 100,
    ];
  }
  ...
  render() {
    ...
    sortIndex = this.sortAccordingArrivalTimeAndBurstTime(
      arrival,
      burst,
      length
    );
        ...
        <div>
          <Row>
            <Col xs={12} sm={12} md={12} xl={12} className="text-left">
              <label>
                Average Turn Around Time: {averagetat[0]} / {averagetat[1]} ={" "}
                {averagetat[2]}
              </label>
            </Col>
            <Col xs={12} sm={12} md={12} xl={12} className="text-right">
              <label>
                Average Turn Around Time: {averagewt[0]} / {averagewt[1]} ={" "}
                {averagewt[2]}
              </label>
            </Col>
          </Row>
